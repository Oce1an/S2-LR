    ...
    : QWidget(parent)
{
    ...
    connect(solveBtn, &QPushButton::clicked, this, &Task4Widget::solveHanoi);
}

void Task4Widget::hanoiOptimized(int n, char from, char to, char mid, QStringList &stepsList)
{
    if (n == 1) {
...
void Task4Widget::hanoiStringBuilder(int n, char from, char to, char mid, QStringList &stepsList)
{
    if (n == 1) {
